...
import com.capztone.admin.ui.activities.SubAdminMainActivity
...
class CategoryAdapter1(
    ...
    private val listener: SubAdminMainActivity
        ...
        fun bind(category: Category) {
            ...
            binding.root.setOnClickListener {
                ...
                if (category.name.equals("discount", ignoreCase = true)) {
                    ...
                    intent = Intent(context, DiscountActivity::class.java)
                } else {
                    // Open AddItemActivity for other categories
                    intent = Intent(context, AddItemActivity::class.java)
