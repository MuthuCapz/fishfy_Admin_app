...
class InventoryAdapter(
...
) : RecyclerView.Adapter<InventoryAdapter.AllItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllItemViewHolder {
        val binding =  AddInventoryItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class AllItemViewHolder(private val binding: AddInventoryItemBinding) :
                        ...
                        orderDetailsRef.addListenerForSingleValueEvent(object : ValueEventListener {
                            override fun onDataChange(orderSnapshot: DataSnapshot) {
                                ...
                                if (skuExistsInConfirmedOrder) {
                                    ...
                                    (context as? Inventory)?.skuExistingCartDialog()
                                } else {
                                    ...
                                    allUsersRef.addListenerForSingleValueEvent(object : ValueEventListener {
                                        override fun onDataChange(snapshot: DataSnapshot) {
                                            ...
                                            if (skuExistsInCart) {
                                                ...
                                                (context as? Inventory)?.showDeleteConfirmationDialog(skuId)
                                            }
                                        }
