...
import com.capztone.admin.ui.activities.SubAdminAllItemsActivity
                                    ...
                                    allUsersRef.addListenerForSingleValueEvent(object :
                                        ...
                                        override fun onDataChange(snapshot: DataSnapshot) {
                                            ...
                                            if (skuExistsInCart) {
                                                ...
                                                (context as? SubAdminAllItemsActivity)?.skuExistingCartDialog()
                                            } else {
                                                // Show a different dialog if the SKU ID does not match any in cartItems
                                                (context as? SubAdminAllItemsActivity)?.showDeleteConfirmationDialog(skuId)
                                            }
                                        }
