...
// Start a delay to hide the loading indicator after 1500 milliseconds (1.5 seconds)
        ...
        adapter = InventoryAdapter(this) { hasData ->
    ...
    private fun fetchShopName() {
        ...
        if (currentUserID != null) {
            val adminRef = database.child("Delivery Details")
            adminRef.child("Shop name").addListenerForSingleValueEvent(object : ValueEventListener {
    ...
    private fun saveDataToFirebase() {
        ...
        currentUserID?.let { userId ->
            ...
            database.child("Delivery Details").child("Shop Id").get().addOnSuccessListener { shopIdSnapshot ->
    ...
    private fun exportDataToCSV() {
        ...
        if (currentUserID != null) {
            // Fetch the shop name
            database.child("Delivery Details").child("Shop Id").get().addOnSuccessListener { dataSnapshot ->
