...
class DiscountProductEditActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDiscountProductEditBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDiscountProductEditBinding.inflate(layoutInflater)
...
// Decrement button functionality with validation for unit selection
    ...
    private fun updateItem(shopName: String, skuId: String?) {
        ...
        // Reference the correct shop path
